 ...
 * on 2015-02-13 at 01:25:34 UTC 
 * Modify at your own risk.
 */

package ctprojects.authentication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://marc-chris-9192.appspot.com/_ah/api/";
  ...
  public class SayHi extends MyApiRequest<ctprojects.authentication.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, ctprojects.authentication.backend.myApi.model.MyBean.class);
  ...
  /**
   * Create a request for the method "sayHiAuth".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link SayHiAuth#execute()} method to invoke the remote operation.
   *
   * @param name
   * @return the request
   */
  public SayHiAuth sayHiAuth(java.lang.String name) throws java.io.IOException {
    SayHiAuth result = new SayHiAuth(name);
    initialize(result);
    return result;
  }

  public class SayHiAuth extends MyApiRequest<ctprojects.authentication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "sayHiAuth/{name}";

    /**
     * Create a request for the method "sayHiAuth".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link SayHiAuth#execute()} method to invoke the remote operation. <p>
     * {@link
     * SayHiAuth#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @param name
     * @since 1.13
     */
    protected SayHiAuth(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, ctprojects.authentication.backend.myApi.model.MyBean.class);
      this.name = com.google.api.client.util.Preconditions.checkNotNull(name, "Required parameter name must be specified.");
    }

    @Override
    public SayHiAuth setAlt(java.lang.String alt) {
      return (SayHiAuth) super.setAlt(alt);
    }

    @Override
    public SayHiAuth setFields(java.lang.String fields) {
      return (SayHiAuth) super.setFields(fields);
    }

    @Override
    public SayHiAuth setKey(java.lang.String key) {
      return (SayHiAuth) super.setKey(key);
    }

    @Override
    public SayHiAuth setOauthToken(java.lang.String oauthToken) {
      return (SayHiAuth) super.setOauthToken(oauthToken);
    }

    @Override
    public SayHiAuth setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (SayHiAuth) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public SayHiAuth setQuotaUser(java.lang.String quotaUser) {
      return (SayHiAuth) super.setQuotaUser(quotaUser);
    }

    @Override
    public SayHiAuth setUserIp(java.lang.String userIp) {
      return (SayHiAuth) super.setUserIp(userIp);
    }
    ...
    public SayHiAuth setName(java.lang.String name) {
      this.name = name;
      return this;
    }

    @Override
    public SayHiAuth set(String parameterName, Object value) {
      return (SayHiAuth) super.set(parameterName, value);
    }
  }
